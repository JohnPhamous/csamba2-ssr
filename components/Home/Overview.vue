        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="list-group">
              <a v-for="r in researchThemes"
                :key="r.name"
                :href="r.link"
                :class="{ 'list-group-item list-group-item-action': r.external,
                          'list-group-item list-group-item-action list-group-item-primary': !r.external }"
              > {{ r.name }}</a>
            </div>
          </div>
